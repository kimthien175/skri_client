...
class PrivateGame extends Game {
  static PrivateGame load({required Map<String, dynamic> room}) {
    var game = PrivateGame._internal(data: room);
  ...
  static Future<void> host() async {
    Game.connect('init_private_room', Game.requestRoomPackage, PrivateGame.load);
  }

  static void join(String code) {
    Map<String, dynamic> requestPackage = Game.requestRoomPackage;
    requestPackage['code'] = code;
    ...
    //#region CHECK ROOM TO JOIN KICKED MEPLAYER OR NOT
    var kickMap = Storage.data['kick'];
    if (kickMap != null) {
    ...
    Game.connect('join_private_room', requestPackage, PrivateGame.load);
  }
