      ...
      ack: (List list) {
        ...
        for (var i = list.length - 1; i >= 0; i--) {
          Game.inst.addMessage(
            (color) => Message.fromJSON(data: list[i], backgroundColor: color),
            head: true,
          );
        }
      },
    ...
    return Stack(
      ...
      children: [
        Container(
          ...
          child: Obx(() {
            final isPerformer = Game.inst.state.value is PerformerDrawStateMixin;
            return TextField(
              mouseCursor: isPerformer ? SystemMouseCursors.forbidden : SystemMouseCursors.text,
              enabled: !isPerformer,
              ...
              ), // Set text and hint text font size
              decoration: InputDecoration(
                ...
                disabledBorder: const OutlineInputBorder(
                  borderSide: BorderSide(color: Color.fromARGB(221, 90, 90, 90), width: 1.0),
                  borderRadius: borderRadius,
                ),
