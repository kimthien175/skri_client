...
class PlayerController extends GetxController with GetTickerProviderStateMixin {
  ...
  late final AnimationController tooltipController = AnimationController(
    duration: AnimatedButton.duration,
    vsync: this,
  );
            ...
            children: [
              ...
              if (inst is PrivateGame && info.id == inst.hostPlayerId.value)
                Positioned(
                  bottom: 0,
                  left: 4,
                  child: Opacity(opacity: 0.7, child: GifManager.inst.misc('owner').builder.init()),
                ),
            ],
          ),
        ),
